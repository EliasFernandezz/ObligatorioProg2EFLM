...
namespace ObligatorioProg2EFLM.Clases
{
    public abstract class BaseDeDatos
    {
        ...
        {
            Cliente cliente1 = new Cliente("Rogelio", "Buendia", "4763296-7");
            Cliente cliente2 = new Cliente("Agusto", "Gomez", "5731924-9");
            Cliente cliente3 = new Cliente("Francisco", "Darboux", "4763296-7");
